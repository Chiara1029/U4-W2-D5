...
//    archive.removeBook("9788804314660");
        ...
        item.ifPresent(e -> System.out.println("Elemento trovato: " + e.getTitle()));

        System.out.print("Search by author: ");
        String authorInput = scanner.nextLine();
        List<LibraryItem> searchAuth = archive.searchByAuthor(authorInput.trim());
...
//        try{
//            saveToDisk((List<LibraryItem>) archive);
//        } catch (IOException e) {
//            System.err.println("Error" + e.getMessage());
//        }
    }

//    public static void saveToDisk(List<LibraryItem> archive) throws IOException {
//        StringBuilder writeFile = new StringBuilder();
//        for (LibraryItem item : archive) {
